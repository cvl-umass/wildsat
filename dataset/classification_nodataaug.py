...
class ClassificationDatasetNoAug(Dataset):
    """
    ...
    def __init__(self, dataset_name:str="aid", split='train50', return_fp = False,resize_size=None,):
        ...
        if dataset_name=="ucm": # NOTE: added since eval won't run otherwise
            logger.debug(f"Reshaping to {final_size},{final_size}")
